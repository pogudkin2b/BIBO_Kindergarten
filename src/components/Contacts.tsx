...
export default function Contacts() {
  ...
  return (
    <section id="contacts" className="py-24 md:py-32 bg-yellow-primary/10 relative overflow-hidden">
      {/* Decorative elements */}
      <div className="absolute top-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-light-gray to-transparent" />
      <div className="absolute -top-32 -right-32 w-64 h-64 bg-white rounded-full blur-3xl" />
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          >
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              {/* Hours */}
              <div className="bg-white rounded-3xl p-6 border border-sand sm:col-span-2">
                ...
                <p className="text-text-secondary">{t.contacts.hours.weekdays}</p>
                <p className="text-text-secondary">{t.contacts.hours.weekend}</p>
              </div>
              ...
              <div className="bg-white rounded-3xl p-6 border border-sand">
                ...
                <p className="text-text-secondary">{t.contacts.address.value}</p>
              </div>
              ...
              <div className="bg-white rounded-3xl p-6 border border-sand">
                ...
                <a href="tel:+995577712351" className="text-text-secondary hover:text-terracotta transition-colors">
              ...
              <div className="bg-white rounded-3xl p-6 border border-sand">
                ...
                <a
                  ...
                  className="text-text-secondary hover:text-[#25D366] transition-colors"
                >
            ...
            <div className="rounded-3xl overflow-hidden h-[300px] shadow-soft-lg">
              <iframe
                ...
                title="БИБО Kindergarten Location"
              />
            </div>
          </motion.div>
          ...
          <motion.div
            ...
            transition={{ duration: 0.6 }}
          >
            <div className="bg-white rounded-3xl p-8 md:p-10 border border-sand shadow-soft-lg">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-5 py-4 rounded-xl border border-sand bg-yellow-primary/10/50 focus:border-sage focus:ring-2 focus:ring-sage/20 transition-all outline-none text-text-primary"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      className="w-full px-5 py-4 rounded-xl border border-sand bg-yellow-primary/10/50 focus:border-sage focus:ring-2 focus:ring-sage/20 transition-all outline-none resize-none text-text-primary"
                    />
                  </div>
