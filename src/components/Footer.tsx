      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 pt-24 pb-12">
        <div className="grid md:grid-cols-4 gap-12 mb-16">
          ...
          <div className="md:col-span-2">
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                <span className="font-display text-2xl block">БИБО</span>
                <span className="text-cream/60 text-xs tracking-widest uppercase">Детский сад</span>
              </div>
            </div>
            ...
            <div className="flex gap-3">
              <motion.a
                ...
                whileTap={{ scale: 0.95 }}
                className="w-11 h-11 bg-white/10 hover:bg-sage rounded-xl flex items-center justify-center transition-colors"
              >
              ...
              <motion.a
                ...
                whileHover={{ scale: 1.1 }}
                whileTap={{ scale: 0.95 }}
                className="w-11 h-11 bg-white/10 hover:bg-[#25D366] rounded-xl flex items-center justify-center transition-colors"
              >
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-cream/60">
              <li className="flex items-start gap-3">
                ...
                <span>1-й тупик Табидзе, 8, 0179, Грузия</span>
              </li>
              <li className="flex items-center gap-3">
                ...
                <a href="tel:+995577712351" className="hover:text-cream transition-colors">+995 577 71 23 51</a>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-cream/10 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-cream/40 text-sm">
            © {currentYear} Детский сад БИБО. {t.footer.rights}
          </p>
